...
<head>
  ...
  <link href="assets/css/style.css" rel="stylesheet" />
    ...
    if(!(request.getSession(true).getAttribute("userId").toString()).isEmpty()){
     ...
     System.out.println("here1"+userType);
     }else{%>
...
<body>
                                             ...
                                             <td><%=data.getProductname() %></td>
                                              <td><%=data.getColour() %></td>
                                               ...
                                               <td><%=data.getStock()%></td>
                                                ...
                                                <td><input type="submit" name=<%=data.getProductId()%> value="edit" onclick="updatefun('<%=data.getProductId()%>')"/></td>
                                                <td><input type="submit" name=<%=data.getProductId()%> value="remove" onclick="delfun('<%=data.getProductId()%>')"/></td>
    ...
    function updatefun(productId){
    	alert("called");
    	window.location.href="<%=request.getContextPath()%>/MyServletProduct?productId="+productId+"&userAction=2";
    	//get call update.java
    }
    function delfun(productId){
    	alert("called");
    	window.location.href="<%=request.getContextPath()%>/MyServletProduct?productId="+productId+"&userAction=5";
    	//get call update.java
    }
    </script>
