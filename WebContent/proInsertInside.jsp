                        ...
                        <form  method="post" >
                            ...
                            <input type="hidden" value=0 name="userAction">
                                <div class="form-group col-md-6">
                                    <input class="form-control" placeholder="Product Name"  id="productname" name="productname" type="text" autofocus required>
                                </div>
                                <div class="form-group col-md-6">
                                    <input class="form-control" placeholder="Model Number" id="modelnumber" name="modelnumber" type="text" autofocus required>
                                </div>
                                <div class="form-group col-md-12">
                                    <input class="form-control" placeholder="colour" id="colour" name="colour" type="text" value="" required>
                                </div>
                                   <div class="form-group col-md-6">
                                    <input class="form-control" placeholder="Price" id="price" name="price" type="text" autofocus required>
                                </div>
                                <div class="form-group col-md-6">
                                    <input class="form-control" placeholder="Stock" id="stock" name="stock" type="text" autofocus required>
                                </div>
    ...
    <script>
    	 ...
    	 $(document).ready(function() {
        	 $("#button").click(function(){
        		 var reqData = "productname="+document.getElementById("productname").value;
           	  reqData += "&modelnumber="+document.getElementById("modelnumber").value;
